...
declare const _default: React.FunctionComponent<import("react-intl").WithIntlProps<IColorsSectionProps & WrappedComponentProps<"intl">>> & {
    WrappedComponent: React.ComponentType<IColorsSectionProps & WrappedComponentProps<"intl">>;
};
