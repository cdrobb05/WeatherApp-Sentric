export declare type IHighchartsAxis = Partial<Highcharts.Axis> & Partial<Highcharts.ExtremesObject> & Highcharts.ChartParallelAxesOptions;
...
declare type IHighchartsPoint = Partial<Highcharts.Point>;
export declare type IHighchartsSeriesOptionsType = Partial<Highcharts.SeriesOptionsType>;
