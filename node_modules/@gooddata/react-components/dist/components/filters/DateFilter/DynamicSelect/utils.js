...
exports.DAY = "GDC.time.date";
exports.WEEK_US = "GDC.time.week_us";
exports.MONTH = "GDC.time.month";
exports.QUARTER = "GDC.time.quarter";
exports.YEAR = "GDC.time.year";
...
var granularityOffsetLimits = (_a = {},
    _a[exports.DAY] = 365,
    _a[exports.WEEK_US] = 104,
    _a[exports.MONTH] = 60,
    _a[exports.QUARTER] = 20,
    _a[exports.YEAR] = 20,
    _a);
...
var getOption = function (offset, granularity, intl) {
    var dateCode = i18n_1.granularityIntlCodes[granularity];
...
var getDefaultOptions = function (granularity, intl) {
    ...
    var negativeOptions = getOptionsForOffsets(lodash_1.range(-optionRange, 0), granularity, intl);
    var positiveOptions = getOptionsForOffsets(lodash_1.range(1, optionRange + 1), granularity, intl);
    return negativeOptions.concat([
        { type: "separator" },
...
var getFullTextOptions = function (offset, granularity, intl) {
    ...
    var offsets = offset !== undefined && absOffset > 1 ? [-absOffset].concat(coreOffsets, [absOffset]) : coreOffsets;
    return getOptionsForOffsets(offsets, granularity, intl);
};
...
exports.findRelativeDateFilterOptionByLabel = function (options, input) {
    var trimmedInput = getTrimmedInput(input);
    return utils_1.getSelectableItems(options).find(function (option) { return option.label === trimmedInput; });
};
exports.findRelativeDateFilterOptionByValue = function (options, value) {
    return utils_1.getSelectableItems(options).find(function (option) { return option.value === value; });
};
exports.getRelativeDateFilterItems = function (input, granularity, intl) {
    if (input === void 0) { input = ""; }
    if (granularity === void 0) { granularity = exports.DAY; }
    var trimmedInput = getTrimmedInput(input);
