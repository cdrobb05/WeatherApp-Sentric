...
var Platform_1 = require("../../../../constants/Platform");
var NUM_OF_MILISECONDS_IN_MINUTE = 60000;
exports.convertDateToPlatformDateString = function (date) {
    return isDate(date) ? moment(date).format(Platform_1.platformDateFormat) : date;
};
exports.convertPlatformDateStringToDate = function (platformDate) {
