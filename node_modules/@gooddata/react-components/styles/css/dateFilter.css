...
.gd-tab {
  ...
  .gd-tab:hover {
    color: #000;
    border-bottom: 3px solid #dde4eb; }
  .gd-tab.is-active {
    color: #000;
...
.gd-dialog.gd-confirm {
  ...
  .gd-dialog.gd-confirm .gd-dialog-close.gd-button-link-dimmed {
    top: 10px; }
...
.gd-date-filter-button {
  ...
  cursor: pointer;
  user-select: none; }
  .gd-date-filter-button.disabled {
    cursor: pointer;
    user-select: auto;
    pointer-events: none; }
  ...
  .drag-preview .gd-date-filter-button::after {
    background: rgba(255, 255, 255, 0.95); }
  .gd-date-filter-button:hover::after {
    border-color: #dde4eb; }
  @media only screen and (min-width: 64.0625em) {
    ...
    .edit-mode-on .gd-date-filter-button:hover::after {
      border-color: #b1c1d1;
      box-shadow: 0 1px 3px 0 rgba(20, 56, 93, 0.09), 0 2px 9px 0 rgba(20, 56, 93, 0.15); } }
  .edit-mode-on .gd-date-filter-button:hover::before {
    z-index: 1;
    top: 8px;
    left: -4px;
    ...
    background: url("data:image/svg+xml,%3Csvg width='7' height='26' viewBox='0 0 7 26' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 4h2v2H0V4zm0-4h2v2H0V0zm5 4h2v2H5V4zm0-4h2v2H5V0zm0 8h2v2H5V8zM0 8h2v2H0V8zm0 4h2v2H0v-2zm5 4h2v2H5v-2zm-5 0h2v2H0v-2zm5 4h2v2H5v-2zm-5 0h2v2H0v-2zm5 4h2v2H5v-2zm-5 0h2v2H0v-2zm5-12h2v2H5v-2z' fill='%23B0BECA' fill-rule='evenodd'/%3E%3C/svg%3E%0A") no-repeat;
    opacity: 0; }
  .gd-date-filter-button:active::after,
  .edit-mode-on .gd-date-filter-button:active::after, .gd-date-filter-button.is-active::after,
  .edit-mode-on .gd-date-filter-button.is-active::after {
    border-color: rgba(31, 52, 73, 0.2);
    box-shadow: inset 0 1px 0 0 rgba(177, 193, 209, 0.65);
    background: #ecf0f5;
    /* Old browsers */
  ...
  .gd-date-filter-button .button-subtitle {
    ...
    .gd-date-filter-button .button-subtitle:only-child::after {
      display: inline-block; }
    .drag-preview .gd-date-filter-button .button-title::after, .drag-preview
    .gd-date-filter-button .button-subtitle::after {
      display: none; }
  .gd-date-filter-button .button-title {
    overflow: hidden;
...
.gd-date-range-picker {
  ...
  justify-content: space-between;
  align-items: center; }
  .gd-date-range-picker-dash {
    margin: 0 5px;
    color: #94a1ad; }
  .gd-date-range-picker-input-wrapper {
    position: relative; }
  .gd-date-range-picker-input .gd-date-range-picker-input-field {
    padding-left: 36px; }
  ...
  .gd-date-range-picker-input-native .gd-date-range-picker-input-field {
    ...
    @media only screen and (min-width: 40.0625em) {
      .gd-date-range-picker-input-native .gd-date-range-picker-input-field {
        min-width: 13em; } }
  .gd-date-range-picker-input-icon {
    position: absolute;
    top: -1px;
    left: 12px;
    display: flex;
    ...
    color: #14b2e2;
    pointer-events: none; }
  .gd-date-range-picker-input-error .gd-date-range-picker-input-field, .gd-date-range-picker-input-error .gd-date-range-picker-input-field:hover, .gd-date-range-picker-input-error .gd-date-range-picker-input-field:focus {
    border-color: #fada23; }
  .gd-date-range-picker-picker {
    ...
    box-shadow: 0 2px 5px 0 rgba(31, 53, 74, 0.15);
    background: #fff;
    user-select: none; }
...
.gd-extended-date-filter-body-mobile .gd-extended-date-filter-body-wrapper {
  flex: 1 1 auto;
  max-height: none;
  padding: 0;
  border-bottom: 1px solid #dde4eb; }
  .gd-extended-date-filter-body-mobile .gd-extended-date-filter-body-wrapper .gd-list-item:last-child {
...
.gd-extended-date-filter-body-mobile .gd-extended-date-filter-exclude-current,
...
.gd-extended-date-filter-body .gd-filter-list-item {
  ...
  text-align: left;
  background: transparent; }
  .gd-extended-date-filter-body .gd-filter-list-item:not(.is-selected):hover {
    background: #ebeff4; }
...
.gd-relative-filter-form-granularity-tabs {
  margin-bottom: 10px; }
  .gd-relative-filter-form-granularity-tabs .gd-tab {
    margin-right: 15px; }
...
.s-exclude-current-perod-enabled {
  color: #464e56; }
