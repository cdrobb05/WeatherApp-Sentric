...
.indigo-table-component {
  ...
  .indigo-table-component .fixedDataTableLayout_footer {
    ...
    white-space: nowrap;
    background: #fff; }
  .indigo-table-component .public_Scrollbar_main, .indigo-table-component .public_Scrollbar_main.public_Scrollbar_mainActive {
    border-color: transparent; }
  .indigo-table-component .public_Scrollbar_main, .indigo-table-component .public_Scrollbar_mainActive {
    background-color: transparent; }
  .indigo-table-component .public_Scrollbar_main:hover .public_Scrollbar_face::after, .indigo-table-component .public_Scrollbar_mainActive .public_Scrollbar_face::after {
    background-color: #b0beca; }
  .indigo-table-component .public_Scrollbar_face::after {
    background-color: rgba(176, 190, 202, 0.3); }
  .indigo-table-component .public_Scrollbar_faceActive::after {
    background-color: #b0beca; }
  .indigo-table-component .public_fixedDataTable_scrollbarSpacer {
    background: none; }
